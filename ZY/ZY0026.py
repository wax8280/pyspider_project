...
class Handler(BaseHandler):
    ...
    url = u'http://youxiputao.com/company/index/page/{}.html'
    ...
    def get_list(self, response):
        ...
        if u'抱歉，暂无您筛选的信息' not in response.text:
            ...
            for i in response.doc('.row h4 a').items():
                url = i.attr.href if u'youxiputao.com' in i.attr.href else u'http://www.youxiputao.com' + i.attr.href
                self.crawl(
                    url,
